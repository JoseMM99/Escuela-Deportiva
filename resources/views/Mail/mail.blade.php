...
<tr>
 <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
<img class="" width="100" height="100" src="https://pisotrece.mx/wp-content/uploads/2021/06/logo-pisotrece.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
</td>
</tr>
 </tbody>
</table>

 <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Bienvenido a Piso Trece Digital</h4>
...
<td style="border-top-width: 0; border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;" class="text-right" align="right" valign="top">{{ $user->email }} </td>
 ...
 <img width="556" height="322" class="img-fluid" src="https://pisotrece.mx/wp-content/uploads/2021/06/logo-pisotrece.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
</div>
 </td>
</tr>
 </tbody>
...
<tr>
 ...
 <div class="text-center text-muted" style="color: #636c72;" align="center">Somos una Agencia Digital con la misión de desarrollar soluciones creativas de marketing digital y desarrollo para nuestros clientes</div>
 <div class="text-center text-muted" style="color: #636c72;" align="center">, que permitan mejorar la comunicación, competitividad y productividad de sus marcas,</div>
 <div class="text-center text-muted " style="color: #636c72;" align="center">productos y/o servicios. </div>
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
 <tbody>
<tr>
 <td height="24" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 24px; width: 100%; height: 24px; margin: 0;" align="left">
...
<tbody>
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Cel.55 5651 2166 </td>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">
 ...
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Correo: contacto@pisotrece.mx</td>
 </tr>
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Facebook: PisoTreceDigital</td>
 </tr>
</tbody>
 </table>
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
